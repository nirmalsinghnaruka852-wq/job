...
import { Icon, IconButton, IsWhen } from "../../../shared/components/core";
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col gap-2">
          <h6 className="text-lg font-semibold text-gray-800">
            AI Automation Software Engineer – Internship (3-Month Paid
            Internship)
          </h6>
      ...
      <IsWhen when={active === "block"}>
        {() => (
          <div className="flex p-4 border border-gray-200 rounded-xl shadow-sm justify-start gap-3 bg-gray-50 transition-all duration-500 ease-in-out opacity-100">
